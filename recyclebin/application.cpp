...
int main()
{
	...
	testplayer.load_media("resources/videos/kurukshetra.mkv");
	...
	testrenderer.set_texture(testplayer.get_video_width(), testplayer.get_video_height(), 4);
	...
	while (!testrenderer.is_window_closed())
	{
		...
		testrenderer.update_texture(testplayer.get_video_buffer() , 4);
